                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="header_top_wrap d-flex justify-content-between align-items-center">
                                ...
                                <div class="text_wrap">
                                    <p><a href="stu_login.html"> <i class="ti-user"></i>  Student</a> <a href="teach_login.html">Professor</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="header_wrap d-flex justify-content-between align-items-center">
                                <div class="header_left">
                                    <div class="logo">
                                        <a href="index.php">
                                            <img src="img/logo.jpg" alt="" height="120" width="270">
                                        </a>
                                    </div>
                                </div>
                                <div class="header_right d-flex align-items-center">
                                    <div class="main-menu  d-none d-lg-block">
                                        <nav>
                                            <ul id="navigation">
                                                <li><a  href="#">home</a></li>
                                                <li><a href="http://mu.ac.in/syllabus">Courses</a></li>
                                                <li><a href="https://ves.ac.in/vesit/">Contact</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                    <div class="Appointment">
                                        <div class="apply_btn">
                                            <button ><a href="stu_login.html"> Login</a></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
